...
public class StreetViewPanoramaNavigationDemoActivity extends AppCompatActivity {
    ...
    // George St, Sydney
    private static final LatLng SYDNEY = new LatLng(40.11000489999999,-88.23565919999999);

    // Cole St, San Fran
    private static final LatLng SAN_FRAN = new LatLng(40.109713, -88.23178289999998);

    // Santorini, Greece
    private static final String SANTORINI = "WddsUw1geEoAAAQIt9RnsQ";

    // LatLng with no panorama
    private static final LatLng INVALID = new LatLng(40.10806940000001,-88.22953769999998);
    ...
    private boolean checkReady() {
        if (mStreetViewPanorama == null) {
            Toast.makeText(this, "Panorama is not ready yet", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
